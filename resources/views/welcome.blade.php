...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="container-fluid">
            @if (Route::has('login'))
                <div class="fixed top-0 right-0 px-6 py-4 sm:block dark:bg-gray-800 mb-3 bg-gray-100" style="width: 100%; z-index: 10 !important;">
                    @auth
                ...
                <div class="row py-5 mt-4">
                    <div class="col-lg-12 mx-auto">
                        <div class="text-white p-5 shadow-sm rounded banner">
                            <h1 class="display-4">Pokemons NFT's</h1>
                            <p class="lead">Compre seu pokemon NFT. Faça seu cadastro para realizar a compra!</p>
                        </div>
                    </div>
                </div>
                <!-- End -->
